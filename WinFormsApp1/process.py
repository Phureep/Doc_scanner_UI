...
if __name__ == "__main__":
    # image_PATH = r"C:\Users\AngKM\source\repos\ZenUI\Image_History\gagagege.jpg"
    # processed_image_path = os.path.join(os.getcwd()+"\Image_Output", "processed_"+os.path.basename(image_PATH))
    # print(processed_image_path)
    # cv2.imwrite(processed_image_path, cv2.imread(image_PATH))
    if len(sys.argv) < 2:
        # process_image(r"C:\Users\AngKM\source\repos\ZenUI\Image_History\gagagege.jpg")
        # print(os.path.join(os.getcwd(), "Image_Output"))
